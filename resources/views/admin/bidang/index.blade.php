                ...
                <div class="page-header-right ms-auto">
                    <div class="page-header-right-items">
                        ...
                        <div class="d-flex align-items-center gap-2 page-header-right-items-wrapper">
                            <a href="{{ route('bidang.create') }}" class="btn btn-md btn-primary">
                ...
                <div class="card border-0 shadow-sm">
                    <div class="card-header bg-white border-bottom d-flex align-items-center justify-content-between">
                        ...
                        <div class="d-flex align-items-center gap-2">
                            ...
                            <button type="button" class="btn btn-sm btn-outline-secondary" data-export-btn data-export-name="data_bidang">
                    ...
                    <div class="px-4 py-2 bg-light border-bottom align-items-center gap-2" id="masterFilterRow" style="display:none;">
                        <div class="input-group input-group-sm" style="max-width:400px;">
                            ...
                            <input type="text" class="form-control" id="masterFilterInput" placeholder="Cari bidang...">
                        ...
                        <div class="table-responsive">
                            <table class="table table-hover mb-0" id="masterTable">
                                ...
                                <tbody>
                                            ...
                                            <td>
                                                <div class="d-flex gap-2">
                                                    ...
                                                    <form action="{{ route('bidang.destroy', $bidang->id_bidang) }}" method="POST"
                                                        class="d-inline" data-name="{{ $bidang->nama }}">
                                                        @csrf
                                                        @method('DELETE')
                                    ...
                                    @empty
                                        <tr>
                                            <td colspan="3" class="text-center text-muted py-4">Tidak ada data bidang
                                            </td>
                                        </tr>
                                    @endforelse
                                </tbody>
