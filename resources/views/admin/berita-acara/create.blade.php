                    ...
                    <div class="row">
                        <div class="col-md-6">
                         ...
                         <div class="col-md-3">
                            <div class="form-group mb-3">
                                ...
                                <input type="text" name="jam_mulai" id="jam_mulai" class="form-control time-input" placeholder="08:00" value="{{ old('jam_mulai') }}" maxlength="5" pattern="^([01][0-9]|2[0-3]):[0-5][0-9]$" title="Format 24 Jam (HH:mm)" required>
                        ...
                        <div class="col-md-3">
                            <div class="form-group mb-3">
                                ...
                                <input type="text" name="jam_selesai" id="jam_selesai" class="form-control time-input" placeholder="10:00" value="{{ old('jam_selesai') }}" maxlength="5" pattern="^([01][0-9]|2[0-3]):[0-5][0-9]$" title="Format 24 Jam (HH:mm)" required>
                                <small class="text-muted">Format 24 Jam (HH:mm)</small>
                            </div>
                        </div>
                    </div>
