        ...
        <div class="page-header">
            <div class="page-header-left d-flex align-items-center">
                <div class="page-header-title">
                    <h5 class="m-b-10 fw-bold text-dark">Detail Usulan</h5>
                </div>
                <ul class="breadcrumb">
            ...
            <div class="page-header-right ms-auto">
                <div class="page-header-right-items">
                    ...
                    <div class="d-flex align-items-center gap-2 page-header-right-items-wrapper">
                        <a href="{{ route('usulan.index') }}" class="btn btn-md btn-secondary shadow-sm">
                            <i class="feather-arrow-left me-2"></i>
                            <span>Kembali</span>
                        </a>
                        <a href="{{ route('usulan.edit', $usulan->id_usulan) }}" class="btn btn-md btn-warning shadow-sm">
            ...
            <div class="col-lg-8">
                <div class="card border-0 shadow-sm">
                    <div class="card-header bg-white border-bottom p-4">
                        <h6 class="m-0 fw-bold text-primary">Informasi Usulan</h6>
                    </div>
                    <div class="card-body">
            ...
            <div class="col-lg-4">
                ...
                <div class="card border-0 shadow-sm mb-3">
                    <div class="card-header bg-white border-bottom d-flex justify-content-between align-items-center p-4">
                        <h6 class="m-0 fw-bold text-primary">Riwayat Usulan</h6>
                    </div>
