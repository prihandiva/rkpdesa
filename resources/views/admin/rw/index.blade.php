            ...
            <div class="page-header">
                <div class="page-header-left d-flex align-items-center">
                    <div class="page-header-title">
                        <h5 class="m-b-10">RW</h5>
                    </div>
                    <ul class="breadcrumb">
                        <li class="breadcrumb-item"><a href="{{ route('admin.dashboard') }}">Home</a></li>
                        <li class="breadcrumb-item">RW</li>
                    </ul>
                </div>
                <div class="page-header-right ms-auto">
                    <div class="page-header-right-items">
                        ...
                        <div class="d-flex align-items-center gap-2 page-header-right-items-wrapper">
                            <a href="{{ route('rw.create') }}" class="btn btn-md btn-primary">
            ...
            <div class="col-12">
                <div class="card border-0 shadow-sm">
                    <div class="card-header bg-white border-bottom d-flex align-items-center justify-content-between">
                        <h6 class="mb-0">Data RW</h6>
                        <div class="d-flex align-items-center gap-2">
                            <button type="button" class="btn btn-sm btn-outline-secondary" data-filter-btn>
                                <i class="feather-filter me-1"></i>Filter
                            </button>
                            <button type="button" class="btn btn-sm btn-outline-secondary" data-export-btn data-export-name="data_rw">
                    ...
                    <div class="px-4 py-2 bg-light border-bottom align-items-center gap-2" id="masterFilterRow" style="display:none;">
                        <div class="input-group input-group-sm" style="max-width:400px;">
                            ...
                            <input type="text" class="form-control" id="masterFilterInput" placeholder="Cari RW, dusun...">
                        ...
                        <div class="table-responsive">
                            <table class="table table-hover mb-0" id="masterTable">
                                ...
                                <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex gap-2">
                                                    <a href="{{ route('rw.show', $item->id_rw) }}"
                                                        class="btn btn-sm btn-outline-info">
                                                        <i class="feather-eye"></i>
                                                    </a>
                                                    <a href="{{ route('rw.edit', $item->id_rw) }}"
                                    ...
                                    @empty
                                        <tr>
                                            <td colspan="3" class="text-center text-muted py-4">Tidak ada data RW</td>
                                        </tr>
                                    @endforelse
                                </tbody>
                            </table>
